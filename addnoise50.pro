pro addnoise50,filein,band,exptime,nexp,fileout
;; read image
...
if band eq 'J' then scale=1884823.*10^(-0.4*(25.-15))*exptime
if band eq 'H' then scale=2243135.*10^(-0.4*(25.-15))*exptime
if band eq 'K' then scale=1195233.*10^(-0.4*(25.-15))*exptime
